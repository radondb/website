...
RadonDB MySQL on kubernetes released version 2.0.0 on August 10, 2021. The deployment method consists of 1.x Helm chart of is completely changed to operator.

# **Thank**
First of all, thank @andyli029 @zhyass @runkecheng @acekingke @hustjieke @molliezhang for submitting the modification.
